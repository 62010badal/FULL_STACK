    ...
    <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
      <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5">
        <div className="lg:col-span-3">
          <form className="bg-slate-200  px-5 py-12 mt-4">
              ...
              <div className="border-b border-gray-900/10 pb-12">
                ...
                <ul role="list">
                  {addreses.map((address) => (
                    <li
                      key={address.email}
                      className="flex justify-between gap-x-4 py-4 px-5 border-solid border-2 border-gray-400"
                    >
        ...
        <div className="lg:col-span-2">
          <div>
            <div className="mx-auto bg-white mt-12 max-w-7xl px-0 sm:px-0 lg:px-8">
              <div className="border border-gray-300 px-4 py-6 sm:px-6">
